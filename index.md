...
My [research](https://rodemann.github.io/_pages/research/) broadly revolves around uncertainty quantification, online learning (theory), and decision theory within machine learning. I try to render machine learning more reliable by representing the involved uncertainties, heavily relying on [imprecise probabilities](https://sipta.org/){:target="_blank"}. I am also interested in interpretable machine learning and anything Bayesian. My first- (and co-)authored research has been published in Q1 journals like Knowledge-Based Systems, TMLR, (Machine Learning) and A*/A conferences like NeurIPS, ICML, ICLR, UAI, ECML-PKDD, (ACL, EMNLP).
