...
I am a post-doctoral researcher in statistical learning at the Rational Intelligence Lab ([ri-lab.org](https://ri-lab.org/)) led by [Krikamol Muandet](https://scholar.google.com/citations?user=E2z5uYsAAAAJ&hl=en) within the [CISPA Helmholtz Center for Information Security](https://cispa.de/en) in Saarbrücken, Germany. I am also affiliated the [Department of Statistics](https://www.statistik.uni-muenchen.de/index.html){:target="_blank"} at Ludwig-Maximilians-Universität (LMU) Munich, where I obtained my PhD in statistics under the advisorship of the late Thomas Augustin.

My [research](https://rodemann.github.io/_pages/research/) broadly revolves around uncertainty quantification, online learning (theory), and decision theory within machine learning. I try to render machine learning more reliable by representing the involved uncertainties, heavily relying on [imprecise probabilities](https://sipta.org/){:target="_blank"}. I am also interested in interpretable machine learning and anything Bayesian. My first- (and co-)authored research has been published in Q1 journals like Knowledge-Based Systems, TMLR, (Machine Learning, IJAR, Information Sciences) and A*/A conferences like NeurIPS, ICML, ICLR, UAI, ECML-PKDD, (ACL, EMNLP).
